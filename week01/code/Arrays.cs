public static class Arrays
{
    ...
    public static double[] MultiplesOf(double number, int length)
    {
        ...
        // 3. Multiply the given number by the position plus one.
    ...
    {
        // Plan:
        // 1. Calculate where the list should be split.
        // 2. Get the values from the split point to the end.
        // 3. Get the values from the beginning to the split point.
        // 4. Clear the original list.
        // 5. Add the second part to the list.
